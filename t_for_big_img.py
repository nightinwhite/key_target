...
saver.restore(sess, "models/e{0}_pixel_rate_loss_V3_background_0.5_new_bn".format(245))#


test_imgs = []
test_name = "mn962"
test_img = cv2.imread("/home/hp/Data/key_target_data/micai/guonei/{0}.tif".format(test_name))
...
for i in range(len(test_imgs)):
    ...
    cv2.imwrite("{0}_big_img_pixel_rate_loss_V3.png".format(test_name), tmp_img1)
