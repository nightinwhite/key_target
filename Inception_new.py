        ...
        with tf.variable_scope(scope,"Inception_v3",reuse=reuse):
            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    branch_0 = sipconv2d.ops(net,depth(64),[1,1], stride=2, scope="a_conv2d")

                with tf.variable_scope('Branch_1'):
                    branch_1 = sipconv2d.ops(net,depth(48),[1,1],scope="b_conv2d_1")
                    branch_1 = sipconv2d.ops(branch_1, depth(64), [5, 5], stride=2, scope='b_conv2d_2')
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = sipconv2d.ops(branch_2, depth(96), [3, 3], stride=2, scope="c_conv2d_3")

                with tf.variable_scope('Branch_3'):
                    branch_3 = layers_lib.avg_pool2d(net, [3, 3], stride=2,padding="SAME",scope='d_AvgPool')
            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    branch_0 = sipconv2d.ops(net,depth(384),[3,3],stride=2,padding="SAME",scope="a_conv2d")

                with tf.variable_scope('Branch_1'):
                    branch_1 = sipconv2d.ops(net,depth(64),[1,1],scope="b_conv2d_1")
                    branch_1 = sipconv2d.ops(branch_1, depth(96), [3, 3], scope='b_conv2d_2')
                    branch_1 = sipconv2d.ops(branch_1, depth(96), [3, 3], stride=2,padding="SAME",scope='b_conv2d_3')

                with tf.variable_scope('Branch_2'):
                    branch_2 = layers_lib.max_pool2d(net,[3,3],stride=2,padding="SAME",scope="c_Max_Pool")
            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    branch_0 = sipconv2d.ops(net, depth(192), [1, 1],  stride=2,scope="a_conv2d")

                with tf.variable_scope('Branch_1'):
                    branch_1 = sipconv2d.ops(net, depth(128), [1, 1], scope="b_conv2d_1")
                    branch_1 = sipconv2d.ops(branch_1, depth(128), [1, 7], scope='b_conv2d_2')
                    branch_1 = sipconv2d.ops(branch_1, depth(192), [7, 1], stride=2, scope='b_conv2d_3')
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = sipconv2d.ops(branch_2, depth(192), [1, 7], stride=2, scope="c_conv2d_5")
            ...
            with tf.variable_scope(end_point):
                with tf.variable_scope('Branch_0'):
                    ...
                    branch_0 = sipconv2d.ops(branch_0,depth(320),[3,3],stride=2,padding="SAME",scope="a_conv2d_2")
                ...
                with tf.variable_scope('Branch_1'):
                    ...
                    branch_1 = sipconv2d.ops(branch_1, depth(192), [3, 3], stride=2,padding="SAME",scope='b_conv2d_4')
